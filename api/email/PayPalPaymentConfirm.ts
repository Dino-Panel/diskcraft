...
function send(email: string, pay_amount) {
  var mailOptions = {
                                      ...
                                      <p style="font-size: 14px; line-height: 140%">
                                        <span
                                          style="
                                            ...
                                            line-height: 25.2px;
                                          "
                                          >Your payment has been received</span
                                        >
                                      </p>
                                    </div>
                                  </td>
                                      ...
                                      <tr>
                                        ...
                                        >
                                          <img
                                            align="center"
                                            border="0"
                                            src="https://diskos.net/cdn/email/image-4.png"
                                            alt="Image"
                                            title="Image"
                                            style="
                                              outline: none;
                                    ...
                                    >
                                      <p style="font-size: 14px; line-height: 140%">
                                        <span
                                          style="
                                            ...
                                            line-height: 19.6px;
                                          "
                                          >Thank you for using ${config.panel.company_name_full} as your
                                          service provider. We hereby confirm we've
                                          received the payment you have done through
                                          PayPal.</span
                                        >
                                      </p>
                                      <p style="font-size: 14px; line-height: 140%">
                                      ...
                                      <p style="font-size: 14px; line-height: 140%">
                                        <span
                                          ...
                                          "
                                          >Payment Amount:
                                          <strong>${config.currency.symbol}${pay_amount}</strong></span
                                        >
                                      </p>
                                    </div>
                                  </td>
                                      ...
                                      >
                                        <span
                                          style="
                                            ...
                                            color: #95a5a6;
                                          "
                                          >&copy; 2021 ${config.panel.company_name_full}</span
                                        >
                                      </p>
                                    </div>
                                  </td>
                                  ...
                                  >
                                    ...
                                    >
                                      <tr>
                                        ...
                                        >
                                          <a
                                            href="${config.panel.url}"
                                            target="_blank"
                                          >
                                            <img
                                              align="center"
                                              border="0"
                                              src="${config.mail.footer_logo}"
                                              alt="Logo"
                                              title="Logo"
                                              style="
                                                outline: none;
                                          ...
                                          <tbody>
                                            <tr style="vertical-align: top">
                                              ...
                                              >
                                                ...
                                                >
                                                  <img
                                                    src="https://diskos.net/cdn/email/image-1.png"
                                                    alt="Email"
                                                    title="Email"
                                                    width="32"
                                                    style="
                                        ...
                                        >
                                          <tbody>
                                            <tr style="vertical-align: top">
                                              ...
                                              >
                                                <a
                                                  href="${config.panel.discord_invite_link}"
                                                  title="Discord"
                                                  target="_blank"
                                                >
                                                  <img
                                                    src="https://diskos.net/cdn/email/image-2.png"
                                                    alt="Discord"
                                                    title="Discord"
                                                    width="32"
                                                    style="
